...
public class IngredientServiceImplTest {
    ...
    //init converters
    public IngredientServiceImplTest(UnitOfMeasureCommandToUnitOfMeasure unitOfMeasureCommandToUnitOfMeasure) {
    ...
    public void setUp() throws Exception {
        ...
        ingredientService = new IngredientServiceImpl(ingredientToIngredientCommand, ingredientCommandToIngredient,
                recipeRepository, unitOfMeasureRepository, unitOfMeasureCommandToUnitOfMeasure);
    }
    ...
    public void testdeleteByRecipeIdAndIngredientId() throws Exception {
        ...
        Set<Ingredient> ingredients = argumentCaptor.getValue().getIngredients();
        assertEquals(ingredients.size(), 2);
        assertFalse(ingredients.stream()
            .anyMatch(ingredient -> ingredient.getId().equals("3")));
    }*/
